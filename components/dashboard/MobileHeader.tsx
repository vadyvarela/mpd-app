  ...
  return (
    <header className="md:hidden fixed top-0 left-0 right-0 h-11 bg-white/80 backdrop-blur-md border-b border-[#E9ECEF] z-[60] flex items-center justify-between px-4">
      <Link href="/" className="flex items-center gap-2">
        <div className="w-6 h-6 bg-[#16a34a] rounded flex items-center justify-center text-white font-bold text-[10px]">M</div>
      ...
      <Link href="/perfil" className="flex items-center gap-2">
        <div className="text-right">
          ...
          <div className="text-[7px] text-[#16a34a] font-bold uppercase tracking-wider leading-none">{getRole(user)}</div>
        </div>
        <div className="w-7 h-7 rounded-full bg-[#f0fdf4] flex items-center justify-center border border-[#16a34a]/10">
